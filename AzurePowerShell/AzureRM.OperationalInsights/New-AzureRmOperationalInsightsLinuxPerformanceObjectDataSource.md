...
## SYNOPSIS
Add new performance counter to be collected from all Linux computers.
...
## DESCRIPTION
The New-AzureRmOperationalInsightsLinuxPerformanceObjectDataSource add performance counters to be collected from all Linux computers.
