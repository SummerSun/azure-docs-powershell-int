...
## SYNOPSIS
Stop collecting IISLog from connected computers.
...
## DESCRIPTION
The Disable-AzureRmOperationalInsightsIISLogCollection cmdlet stop collecting IISLog from all connected computer in a workspace.
