...
## SYNOPSIS
Collect Azure audit log from given subscription.
...
## DESCRIPTION
The New-AzureRmOperationalInsightsAzureAuditDataSource enable Log Analytics to collect Azure audit log from given subscription.
