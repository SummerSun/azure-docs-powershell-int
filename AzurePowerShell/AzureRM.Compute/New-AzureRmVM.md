...
New-AzureRmVM [-ResourceGroupName] <String> [-Location] <String> [-VM] <PSVirtualMachine>
 [-DisableBginfoExtension] [-Tags <Hashtable>] [-LicenseType <String>] [-InformationAction <ActionPreference>]
...
Disable the BG Info extension from being installed on the Virtual Machine
...
If this element is included in a request for an update, the value must match the intitial value.
