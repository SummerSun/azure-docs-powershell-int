...
If the Name parameter is not specified, extension with the name "AzureDiskEncryption/AzureDiskEncryptionForLinux" (depending on the OS) is used.
...
### -VolumeType
Specifes the type of virtual machine volumes to perform the encryption operation.
