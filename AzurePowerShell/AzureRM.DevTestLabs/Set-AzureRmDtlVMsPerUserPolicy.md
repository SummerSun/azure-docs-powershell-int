...
## SYNOPSIS
Sets the VMs per user policy of a lab in DevTest Labs.
...
## DESCRIPTION
Sets the VMs per user policy of a lab, which allows you set the maximum number of VMs allowed per user.
