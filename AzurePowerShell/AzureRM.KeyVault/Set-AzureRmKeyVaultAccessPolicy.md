...
## DESCRIPTION
The Set-AzureRmKeyVaultAccessPolicy cmdlet grants or modifies existing permissions for a user, application, or security group to perform the specified operations with an Azure Key Vault instance.
...
### Example 5: Enable secrets to be retrieved from a vault by the Microsoft.Compute resource provider
```
