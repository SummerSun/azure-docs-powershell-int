...
```
Get-AzureRmKeyVault [-ResourceGroupName] <String>
```

### ListAllVaultsInSubscription
```
Get-AzureRmKeyVault [-Tag <Hashtable>]
```

## DESCRIPTION
The Get-AzureRmKeyVault cmdlet gets information about the Azure Key Vault instances in a subscription.
