...
Add-AzureKeyVaultKey [-VaultName] <String> [-Name] <String> -KeyFilePath <String>
 ...
 [-Expires <DateTime>] [-NotBefore <DateTime>] [-Tags <Hashtable>]
```

## DESCRIPTION
The Add-AzureKeyVaultKey cmdlet creates a key in a key vault in Azure Key Vault, or imports a key into a vault.
...
For more information about resource tags, see Using tags to organize your Azure resources (http://go.microsoft.com/fwlink/?LinkId=613624).
