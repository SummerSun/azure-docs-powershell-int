...
### -Method
The Method for Http and Https Action types (GET, PUT, POST, HEAD or DELETE).
...
### -RequestBody
The Body for PUT and POST job actions.
...
The Http Authentication type (None, Basic, ClientCertificate, or OAuth).
...
### -ExecutionCount
Count of occurrences that will execute.
Optional.
Default will recur infinitely.
