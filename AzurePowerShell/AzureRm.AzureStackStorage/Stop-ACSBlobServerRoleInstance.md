...
## SYNOPSIS
Stop blob service instance on a specific physical node.
...
stop-ACSBlobServerRoleInstance -ResourceGroupName $resourceGroup -FarmName $farm.Name -InstanceID 'YourInstanceID'
```
