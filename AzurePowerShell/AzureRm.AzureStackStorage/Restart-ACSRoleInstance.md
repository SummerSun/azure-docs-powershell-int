...
## SYNOPSIS
Restart a role instance in the Azure Consistent Storage system.
...
Restart-ACSRoleInstance -ResourceGroupName $resourceGroup -FarmName $farm.Name -InstanceID 'YourInstanceID'
```
